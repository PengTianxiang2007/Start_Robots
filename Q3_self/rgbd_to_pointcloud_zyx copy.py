...
if __name__ == "__main__":
    ...
    extrinsics_hand = np.array([[-0.01055423,  0.00670847,  0.9999218 , -0.06587628],
 [-0.99989719,  0.00963658, -0.01061862,  0.03709994],
 [-0.00970706, -0.99993106,  0.00660607,  0.08367081],
 [ 0.        ,  0.        ,  0.        ,  1.        ]])     
    ...
    # 1b) 初始化 - 第三方相机
    extrinsics_head = np.array([[ 0.01208342, -0.8002994 ,  0.59947882,  0.00234587],
 [-0.9999163 , -0.01244393,  0.00354231, -0.19137972],
 [ 0.00462496, -0.59947145, -0.80038278,  0.64543168],
 [ 0.        ,  0.        ,  0.        ,  1.        ]]) 
    work_space = [[0, 0.7], [-0.5, 0.5],  [-0.4, 1]]
