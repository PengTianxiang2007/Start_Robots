...
if __name__ == "__main__":
    ...
    extrinsics_hand = np.array([
        [-0.01072563,  0.00700805,  0.99991792, -0.06865714],
        [-0.99984976,  0.01354176, -0.01081981,  0.03680065],
        [-0.01361647, -0.99988375,  0.00686175,  0.08139294],
        [ 0.        ,  0.        ,  0.        ,  1.        ]])
    ...
    # 1b) 初始化 - 第三方相机
    extrinsics_head = np.array([
        [-0.01327222, -0.80184472,  0.59738505, -0.0057072 ],
        [-0.99981743,  0.01885534,  0.00309559, -0.19469561],
        [-0.01374609, -0.5972349 , -0.80194858,  0.65446397],
        [ 0.        ,  0.        ,  0.        ,  1.        ]])
